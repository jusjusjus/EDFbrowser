...
HEADERS += color_options.h
HEADERS += signaltype_options.h
HEADERS += filter.h
...
HEADERS += Signaltypes.h
HEADERS += Signaltype.h
HEADERS += Event.h
HEADERS += Signaltype_dialog.h
HEADERS += epochs_dock.h
...
SOURCES += color_options.cpp
SOURCES += signaltype_options.cpp
SOURCES += filter.cpp
...
SOURCES += epochs_dock.cpp
SOURCES += Signaltypes.cpp
SOURCES += Signaltype.cpp
SOURCES += Event.cpp
SOURCES += Signaltype_dialog.cpp
